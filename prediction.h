...
public slots:
    ...
    void predictCyclones(const QString &lat1, const QString &lng1,const QString &lat2, const QString &lng2, const QString& mid, const QString& burnin, const QString& update, const QString& elSeason);
